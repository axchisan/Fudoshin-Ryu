...
export function HomeBlogPreview() {
  const blogPosts = [
    {
      title: "Historia del Karate Shotokan",
      excerpt: "Descubre el origen y evolución del Karate Shotokan, una de las disciplinas más respetadas del mundo.",
      date: "2024-12-01",
      slug: "historia-karate-shotokan",
    },
    {
      title: "Cómo Comenzar tu Entrenamiento",
      excerpt:
        "Guía práctica para los principiantes: desde la elección del dojo hasta los primeros movimientos básicos.",
      date: "2024-11-28",
      slug: "como-comenzar-entrenamiento",
    },
    {
      title: "Beneficios del Karate para Niños",
      excerpt: "El karate no solo desarrolla habilidades marciales, sino también disciplina, confianza y autocontrol.",
      date: "2024-11-25",
      slug: "beneficios-karate-ninos",
    },
  ]
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          {blogPosts.map((post, idx) => (
            ...
            >
              ...
              <Link
                href={`/blog/${post.slug}`}
                className="text-red-600 font-semibold hover:text-red-700 transition-smooth flex items-center gap-2"
              >
